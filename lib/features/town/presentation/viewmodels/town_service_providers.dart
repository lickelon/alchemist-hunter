...
final Provider<MercenaryRecruitmentService>
mercenaryRecruitmentServiceProvider = Provider<MercenaryRecruitmentService>(
  (Ref ref) => const MercenaryRecruitmentService(),
);

final Provider<TownSkillTreeService> townSkillTreeServiceProvider =
    Provider<TownSkillTreeService>((Ref ref) => const TownSkillTreeService());
