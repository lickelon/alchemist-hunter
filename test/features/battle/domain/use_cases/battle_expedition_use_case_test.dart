...
void main() {
  test(
    'claimStageRewards does not unlock next stage for failed zero-payout battle',
    () {
      ...
      expect(
        nextState.battle.progress.clearedStageIds,
        isNot(contains('stage_2')),
      );
      expect(
        nextState.battle.progress.unlockFlags,
        isNot(contains('potion_special_1')),
      );
    },
  );
}
